...
.pomodoro-direction-rtl .pomodoro-animated-controls { right: auto; left: 50%; transform: translateX(-50%); margin-bottom: 4px; }
	...
	.pomodoro-progress-trail { position: absolute; bottom: 4px; left: 12px; right: 12px; height: 12px; background: var(--interactive-accent, #7ee787); opacity: 0.1; border-radius: 6px; overflow: hidden; }
	.pomodoro-white-track { position: absolute; top: 0; left: 0; height: 100%; width: 0%; background: var(--interactive-accent, #7ee787); opacity: 0.85; transition: width 0.3s ease; border-radius: 6px; }
